...
const HomePage = () => {
    ...
    const carouselSlides = [
        {
            ...
            description: "Empowering learners across Africa with cutting-edge STEM education, digital literacy, and entrepreneurship skills for the 21st century.",
            image: "https://images.unsplash.com/photo-1637148778990-621fbe8a8358?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQzfHxlbGVhcm5pbmd8ZW58MHx8MHx8fDA%3D"
        },
        {
            title: "Get Educated Online From Your Home",
            subtitle: "Best Online Courses",
            description: "Access world-class education anywhere, anytime. Our platform brings quality learning directly to your home with interactive courses and expert instructors.",
            image: "https://plus.unsplash.com/premium_photo-1681487729805-91f220c7da25?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8ZWxlYXJuaW5nfGVufDB8fDB8fHww"
        }
    ];
    ...
    const services = [
        ...
        },
        {
            ...
            description: "Access courses anytime, anywhere with our mobile-friendly platform designed for low-bandwidth environments."
        },
        {
            icon: Home,
            title: "Practical Projects",
            description: "Apply your learning through hands-on projects that solve real community and business challenges."
        },
        {
            icon: BookOpen,
            title: "Resource Library",
            description: "Extensive collection of PDFs, toolkits, case studies, and reference materials for continued learning."
        }
    ];
    ...
    const courses = [
        {
            ...
            duration: "8 weeks",
            students: 156,
            image: "https://images.unsplash.com/photo-1634951401794-6c84f593db82?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8RGlnaXRhbCUyMEZpbmFuY2lhbCUyMExpdGVyYWN5JTIwRXNzZW50aWFsc2FTVEVNJTIwRm91bmRhdGlvbnMlMjBmb3IlMjBZb3VuZyUyMElubm92YXRvcnN8ZW58MHx8MHx8fDA%3D",
            level: "Beginner"
        },
        {
            ...
            duration: "6 weeks",
            students: 203,
            image: "https://images.unsplash.com/photo-1634586720560-d5c61d450133?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8RGlnaXRhbCUyMEZpbmFuY2lhbCUyMExpdGVyYWN5JTIwRXNzZW50aWFsc3xlbnwwfHwwfHx8MA%3D%3D",
            level: "Intermediate"
        },
        {
            ...
            duration: "12 weeks",
            students: 98,
            image: "https://plus.unsplash.com/premium_photo-1723672919439-c37b99155360?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGFmcmljYSUyMEdyZWVuJTIwRW50cmVwcmVuZXVyc2hpcCUyMEJvb3RjYW1wfGVufDB8fDB8fHww",
            level: "Advanced"
        }
    ];
    ...
    const categories = [
        {
            name: "STEM Education",
            courses: 24,
            image: "https://images.unsplash.com/photo-1631378297854-185cff6b0986?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8c3RlbSUyMGVkdWNhdGlvbnxlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            name: "Digital & Financial Literacy",
            courses: 18,
            image: "https://plus.unsplash.com/premium_photo-1661371340750-f9b83c2e2c51?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGRpZ2l0YWwlMjBhbmQlMjBmaW5hbmNpYWwlMjBsaXRlcmFjeXxlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            name: "Green Entrepreneurship",
            courses: 15,
            image: "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGVudHJlcHJlbmV1cnNoaXB8ZW58MHx8MHx8fDA%3D"
        },
        {
            name: "Faith-Based Coaching",
            courses: 12,
            image: "https://images.unsplash.com/photo-1594453843726-b465f1cac129?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8ZmFpdGglMjBiYXNlYiUyMGNvYWNoaW5nfGVufDB8fDB8fHww"
        }
    ];
                            ...
                            >
                                <div className="container mx-auto px-6">
                                    <div className="max-w-2xl">
                                        <h5 className="text-primary font-semibold text-lg mb-4 animate-fade-in-up">
                                            {slide.subtitle}
                                        </h5>
                                        <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in-up animation-delay-200">
                                            {slide.title}
                                        </h1>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-600">
                                            ...
                                            <Button
                                                variant="outline"
                                                size="lg"
                                                className="bg-white/10 border-white text-white hover:bg-white hover:text-slate-900 hover:scale-105 transition-all duration-200"
                                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                <h5 className="text-xl font-semibold mb-4 text-foreground group-hover:text-primary transition-colors duration-300">
                                    {service.title}
                                </h5>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="relative">
                            ...
                            {/* Floating stats card */}
                            <div className="absolute -bottom-8 -right-8 bg-primary text-white p-6 rounded-xl shadow-lg">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                                We're building Africa's future through transformative education that bridges traditional knowledge with cutting-edge skills for the digital age.
                            </p>
                            <p className="text-muted-foreground mb-8 leading-relaxed">
                                Our comprehensive programs span STEM education, digital financial literacy, green entrepreneurship, and faith-based coaching - all designed to empower learners across Rwanda and beyond.
                            </p>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="lg:col-span-2 lg:row-span-2">
                            <div className="relative h-full min-h-[400px] rounded-2xl overflow-hidden group cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500">
                                <img
                                ...
                                <div className="absolute bottom-6 left-6 right-6">
                                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                        <h3 className="text-xl font-bold text-slate-900 mb-1">{categories[0].name}</h3>
                                        <p className="text-primary font-semibold">{categories[0].courses} Courses Available</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {categories.slice(1).map((category, index) => (
                            <div key={index} className="lg:col-span-2">
                                <div className="relative h-48 rounded-2xl overflow-hidden group cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300">
                                    <img
                                        src={category.image}
                                        alt={category.name}
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4">
                                        <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 transform translate-y-1 group-hover:translate-y-0 transition-transform duration-300">
                                            <h4 className="font-bold text-slate-900 mb-1">{category.name}</h4>
                                            <p className="text-sm text-primary font-semibold">{category.courses} Courses</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex items-center justify-between mb-3">
                                        <h3 className="text-2xl font-bold text-primary">{course.price}</h3>
                                ...
                                <div className="relative -mt-6 mx-4">
                                    <div className="bg-card border border-border rounded-xl p-1 shadow-lg">
                                        <div className="flex justify-center space-x-2 py-2">
                                            {['facebook-f', 'twitter', 'linkedin-in'].map((social, socialIndex) => (
                                                <Button
                                                    key={socialIndex}
                                                    size="icon"
                                                    variant="ghost"
                ...
                <div className="container mx-auto px-6 text-center">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-xl text-gray-200 mb-8 leading-relaxed">
                            Join thousands of learners who are building skills for tomorrow. Start your journey today with courses designed for the African context.
                        </p>
                    ...
                    <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-lg">
                        <div className="grid lg:grid-cols-2 gap-8 items-center">
                            <div>
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Get the latest updates on new courses, success stories, and educational insights delivered straight to your inbox.
                                </p>
                            </div>
