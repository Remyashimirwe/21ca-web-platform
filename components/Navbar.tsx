    ...
    return (
        <motion.nav 
            ...
            className={`fixed top-0 left-0 right-0 z-50 font-poppins transition-all duration-500 ${
                scrolled
                    ? 'bg-background/85 backdrop-blur-2xl border-b border-border/40 shadow-lg shadow-black/5 py-2'
                    : 'bg-background/65 backdrop-blur-xl border-b border-transparent py-3'
            }`}
        >
